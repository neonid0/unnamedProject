...
// Pasted component
// just try to understand the main structer
export default function SearchBar({ onSelectCategory, onSearch }) {
                                        ...
                                        {searchResults.length > 0 ? (
                                            searchResults.map((result) => (
                                                <li key={result.productId} className="list-group-item">
                                                    <a href={`/product/${result.productId}`} className="search-result-link">
